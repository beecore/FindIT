...
public class GameManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        GoogleMobileAdsManager.instance.ShowBannerAd();
 ...
 if(Input.touchCount > 0)
    ...
    {
        GoogleMobileAdsManager.instance.ShowRewardedAd(GoogleMobileAdsManager.REWARD_TYPE.HINT);
    ...
    public void ContinueGame()
    {
       // AdsControl.Instance.ShowRewardedAd(AdsControl.REWARD_TYPE.MORE_TIME);
        GoogleMobileAdsManager.instance.ShowRewardedAd(GoogleMobileAdsManager.REWARD_TYPE.MORE_TIME);
    }
