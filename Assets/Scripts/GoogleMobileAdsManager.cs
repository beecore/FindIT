...
public class GoogleMobileAdsManager : MonoBehaviour
{
    ...
    // These ad units are configured to always serve test ads.
#if UNITY_ANDROID
    private  string _adInterUnitId = "ca-app-pub-3940256099942544/1033173712";
#elif UNITY_IPHONE
  ...
  private string _adRewardUnitId = "unused";
    ...
    private void Awake()
    {
        if (isTest)
        {
            ...
            _adInterUnitId = "ca-app-pub-3940256099942544/1033173712";
    ...
    public void LoadInterstitialAd()
    {
        ...
        // Send the request to load the ad.
        InterstitialAd.Load(_adInterUnitId, adRequest, (InterstitialAd ad, LoadAdError error) =>
        {
    ...
    public void ShowRewardAd()
    {
        if (_rewardedAd != null && _rewardedAd.CanShowAd())
        {
            ...
            _rewardedAd.Show((Reward reward) =>
            {
                ...
                if (currentType == REWARD_TYPE.MORE_TIME)

                    GameManager.instance.ShowContinueRW();

                else if (currentType == REWARD_TYPE.HINT)
                    GameManager.instance.ShowHintRW();
